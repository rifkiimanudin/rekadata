                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="" class="badge badge-success" data-toggle="modal" data-target="#editMenu<?= $m['id']; ?>">edit</a>
                                <a href="<?php echo site_url('menu/delete_menu/' . $m['id']); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?= $m['menu']; ?> ?');" class="badge badge-danger">hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <div class="modal-content">
                ...
                <form action="<?= base_url('menu/edit_menu'); ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="menu" name="menu" value="<?= $m['menu']; ?>" autocomplete="off">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
