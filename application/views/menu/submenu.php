                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo site_url('menu/delete_submenu/' . $sm['id']); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data <?= $sm['menu']; ?> ?');" class="badge badge-danger">hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
foreach ($subMenu as $sm) : $no++; ?>
    <div class="modal fade" id="editSubMenu<?= $sm['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editSubMenu" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editSubMenu">Edit Sub Menu</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
